  ...
  return (
    <>
      {loginType.logo === "naver" ? (
        ...
        <Anchor
          href='https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=845bad711438ba325143c971ec350d2d&redirect_uri=http://3.12.151.96:8080/login/oauth2/code/kakao'
          color={loginType.color}
        >
